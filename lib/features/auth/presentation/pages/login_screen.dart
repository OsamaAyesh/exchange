...
//                               .getValue(PrefKeys.loggedIn.name)) {
//                             final bool isAuthenticated =
//                                 await LocalAuth.authenticate() ?? false;
//                             if (isAuthenticated) {
...
//                             } else {
//                               context.showSnackBar(
//                                   message: "لم يتم تسجيل الدخول", erorr: true);
//                             }
//                           } else {
//                             context.showSnackBar(
//                                 message:
//                                     "يجب تسجيل الدخول عن طريق البريد الإلكتروني وكلمة المرور",
//                                 erorr: true);
//                           }
//                         },
//                         child: Container(
...
//     context.showSnackBar(
//         message:
//             "يرجى تعبئة الحقول الفارغة الخاصة بالبريد الالكتروني وكلمة المرور",
//         erorr: true);
//     return false;
//   }
//
