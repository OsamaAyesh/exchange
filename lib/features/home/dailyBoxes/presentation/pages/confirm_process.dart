...
class ConfirmProcess extends StatefulWidget {
  ...
  ConfirmProcess({super.key, required this.numberId});
                                ...
                                children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ColumnDataWidgetProcessDetails(
                                            title: "رقم العملية",
                                            subTitle: data.data?.number??"0", maxLines: 1,),
                                        // استخدم `transaction` هنا
                                        ColumnDataWidgetProcessDetails(
                                            title: "حالة العملية",
                                            subTitle: data.data?.typeName??"0", maxLines: 1,),
                                        ColumnDataWidgetProcessDetails(
                                            title: "تاريخ العملية",
                                            subTitle: data.data?.date??"لا يوجد", maxLines: 1,),
                                      ],
                                    ),
                                  ),
                                  SizedBox(height: ScreenUtilNew.height(16)),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ColumnDataWidgetProcessDetails(
                                            title: "العمولة",
                                            subTitle:
                                                "${data.data?.commissionValue??"لا يوجد"}%", maxLines: 1,),
                                        ColumnDataWidgetProcessDetails(
                                            title: "إسم الخدمة",
                                            subTitle: data.data?.serviceName??"لا يوجد", maxLines: 1,),
                                        ColumnDataWidgetProcessDetails(
                                            title: "إسم المصدر",
                                            subTitle: data.data?.sourceName??"لا يوجد", maxLines: 1,),
                                      ],
                                    ),
                                  ),
                                  SizedBox(height: ScreenUtilNew.height(16)),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ColumnDataWidgetProcessDetails(
                                            ...
                                            subTitle: "${data.data?.total??"0"}%", maxLines: 1,),
                                        ColumnDataWidgetProcessDetails(
                                            title: "المبلغ",
                                            subTitle: data.data?.amount??'', maxLines: 1,),
                                        ColumnDataWidgetProcessDetails(
                                            title: "مبلغ الزيادة",
                                            subTitle:
                                  ...
                                  Padding(
                                    ...
                                    child: ColumnDataWidgetProcessDetails(
                                        title: "الملاحظات",
                                        subTitle: data.data?.notes ??"لا يوجد", maxLines: 3,),
                                  ),
                                  SizedBox(height: ScreenUtilNew.height(16)),
                                ],
                              ),
