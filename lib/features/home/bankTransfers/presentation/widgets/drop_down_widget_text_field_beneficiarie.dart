...
class DropDownWidgetTextFieldBeneficiarie extends StatefulWidget {
  ...
  const DropDownWidgetTextFieldBeneficiarie({
    super.key,
  ...
  @override
  State<DropDownWidgetTextFieldBeneficiarie> createState() =>
      _DropDownWidgetTextFieldBeneficiarieState();
}

class _DropDownWidgetTextFieldBeneficiarieState extends State<DropDownWidgetTextFieldBeneficiarie> {
