...
class DropDownWidgetTextFieldAccount extends StatefulWidget {
  ...
  const DropDownWidgetTextFieldAccount(
  ...
  @override
  State<DropDownWidgetTextFieldAccount> createState() =>
      _DropDownWidgetTextFieldState();
}

class _DropDownWidgetTextFieldState extends State<DropDownWidgetTextFieldAccount> {
